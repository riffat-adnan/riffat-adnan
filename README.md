...
</svg>JavaScript, TypeScript, React.js, Next.js, Vue, Express.js, Nest.js, MySQL, Postgres, SQLite, MongoDB, Redis, NoSQL, Node.js, AWS, Azure, Heroku,Git, Linux, Windows & Mac
